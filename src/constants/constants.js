export const projects = [
   ...
   
  {
    ...
    description: "Design that I recreated from https://www.frontendpractice.com  to practise HTML and CSS3 concepts, learned from courses.",
      image: '/images/3.jpg',
      tags: ['HTML5', 'CSS'],
...
export const TimeLineData = [
  ...
  { year: 2015, text: 'Started working as intern, then as programmer/etl developer', },
